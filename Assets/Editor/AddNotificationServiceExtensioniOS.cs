...
{
    private const string NotificationServicePath = "Assets/NotificationService/";
    ...
    private static void PostProcessBuild_iOS(BuildTarget target, string buildPath)
    {
        ...
        File.Copy($"{NotificationServicePath}/NotificationService.h", buildPath + "/NotificationService/NotificationService.h");
        File.Copy($"{NotificationServicePath}/NotificationService.m", buildPath + "/NotificationService/NotificationService.m");
        File.Copy($"{NotificationServicePath}/Info.plist", buildPath + "/NotificationService/Info.plist");
        ...
        {
            Debug.Log("[PostProcessBuild_iOS] Can't load Info.plist location: " + e);
        }
        ...
        {
            Debug.Log("[PostProcessBuild_iOS] Can't load BundleId: " + e);
        ...
        Debug.Log("[PostProcessBuild_iOS] COMPLETE");
    }
}
